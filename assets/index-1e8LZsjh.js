 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(B,Y){var te=B.length;B.push(Y);e:for(;0<te;){var de=te-1>>>1,ue=B[de];if(0<i(ue,Y))B[de]=Y,B[te]=ue,te=de;else break e}}function n(B){return B.length===0?null:B[0]}function r(B){if(B.length===0)return null;var Y=B[0],te=B.pop();if(te!==Y){B[0]=te;e:for(var de=0,ue=B.length,j=ue>>>1;de<j;){var K=2*(de+1)-1,Q=B[K],G=K+1,we=B[G];if(0>i(Q,te))G<ue&&0>i(we,Q)?(B[de]=we,B[G]=te,de=G):(B[de]=Q,B[K]=te,de=K);else if(G<ue&&0>i(we,te))B[de]=we,B[G]=te,de=G;else break e}}return Y}function i(B,Y){var te=B.sortIndex-Y.sortIndex;return te!==0?te:B.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],h=[],f=1,m=null,y=3,k=!1,x=!1,D=!1,O=typeof setTimeout=="function"?setTimeout:null,w=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function A(B){for(var Y=n(h);Y!==null;){if(Y.callback===null)r(h);else if(Y.startTime<=B)r(h),Y.sortIndex=Y.expirationTime,e(u,Y);else break;Y=n(h)}}function V(B){if(D=!1,A(B),!x)if(n(u)!==null)x=!0,yr(U);else{var Y=n(h);Y!==null&&jt(V,Y.startTime-B)}}function U(B,Y){x=!1,D&&(D=!1,w(g),g=-1),k=!0;var te=y;try{for(A(Y),m=n(u);m!==null&&(!(m.expirationTime>Y)||B&&!C());){var de=m.callback;if(typeof de=="function"){m.callback=null,y=m.priorityLevel;var ue=de(m.expirationTime<=Y);Y=t.unstable_now(),typeof ue=="function"?m.callback=ue:m===n(u)&&r(u),A(Y)}else r(u);m=n(u)}if(m!==null)var j=!0;else{var K=n(h);K!==null&&jt(V,K.startTime-Y),j=!1}return j}finally{m=null,y=te,k=!1}}var M=!1,E=null,g=-1,_=5,I=-1;function C(){return!(t.unstable_now()-I<_)}function R(){if(E!==null){var B=t.unstable_now();I=B;var Y=!0;try{Y=E(!0,B)}finally{Y?S():(M=!1,E=null)}}else M=!1}var S;if(typeof v=="function")S=function(){v(R)};else if(typeof MessageChannel<"u"){var mt=new MessageChannel,ln=mt.port2;mt.port1.onmessage=R,S=function(){ln.postMessage(null)}}else S=function(){O(R,0)};function yr(B){E=B,M||(M=!0,S())}function jt(B,Y){g=O(function(){B(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(B){B.callback=null},t.unstable_continueExecution=function(){x||k||(x=!0,yr(U))},t.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):_=0<B?Math.floor(1e3/B):5},t.unstable_getCurrentPriorityLevel=function(){return y},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(B){switch(y){case 1:case 2:case 3:var Y=3;break;default:Y=y}var te=y;y=Y;try{return B()}finally{y=te}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(B,Y){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var te=y;y=B;try{return Y()}finally{y=te}},t.unstable_scheduleCallback=function(B,Y,te){var de=t.unstable_now();switch(typeof te=="object"&&te!==null?(te=te.delay,te=typeof te=="number"&&0<te?de+te:de):te=de,B){case 1:var ue=-1;break;case 2:ue=250;break;case 5:ue=1073741823;break;case 4:ue=1e4;break;default:ue=5e3}return ue=te+ue,B={id:f++,callback:Y,priorityLevel:B,startTime:te,expirationTime:ue,sortIndex:-1},te>de?(B.sortIndex=te,e(h,B),n(u)===null&&B===n(h)&&(D?(w(g),g=-1):D=!0,jt(V,te-de))):(B.sortIndex=ue,e(u,B),x||k||(x=!0,yr(U))),B},t.unstable_shouldYield=C,t.unstable_wrapCallback=function(B){var Y=y;return function(){var te=y;y=Y;try{return B.apply(this,arguments)}finally{y=te}}}})(ny);ty.exports=ny;var pE=ty.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wI=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),ve=(t,e)=>{const n=xe.forwardRef(({color:r="currentColor",size:i=24,strokeWidth:s=2,absoluteStrokeWidth:o,className:l="",children:u,...h},f)=>xe.createElement("svg",{ref:f,...vI,width:i,height:i,stroke:r,strokeWidth:o?Number(s)*24/Number(i):s,className:["lucide",`lucide-${wI(t)}`,l].join(" "),...h},[...e.map(([m,y])=>xe.createElement(m,y)),...Array.isArray(u)?u:[u]]));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const PI=ve("Printer",[["polyline",{points:"6 9 6 2 18 2 18 9",key:"1306q4"}],["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["rect",{width:"12",height:"8",x:"6",y:"14",key:"5ipwut"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xI=ve("Save",[["path",{d:"M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z",key:"1owoqh"}],["polyline",{points:"17 21 17 13 7 13 7 21",key:"1md35c"}],["polyline",{points:"7 3 7 8 15 8",key:"8nz8an"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tS="FirebaseError";class Dn extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=tS,Object.setPrototypeOf(this,Dn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,vo.prototype.create)}}class vo{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},i=`${this.service}/${e}`,s=this.errors[e],o=s?nS(s,r):"Error",l=`${this.serviceName}: ${o} (${i}).`;return new Dn(i,l,r)}}function nS(t,e){return t.replace(rS,(n,r)=>{const i=e[r];return i!=null?String(i):`<${r}?>`})}const rS=/\{\$([^}]+)}/g;function iS(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function dl(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const i of n){if(!r.includes(i))return!1;const s=t[i],o=e[i];if(Cm(s)&&Cm(o)){if(!dl(s,o))return!1}else if(s!==o)return!1}for(const i of r)if(!n.includes(i))return!1;return!0}function Cm(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ie;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(ie||(ie={}));const dS={debug:ie.DEBUG,verbose:ie.VERBOSE,info:ie.INFO,warn:ie.WARN,error:ie.ERROR,silent:ie.SILENT},fS=ie.INFO,pS={[ie.DEBUG]:"log",[ie.VERBOSE]:"log",[ie.INFO]:"info",[ie.WARN]:"warn",[ie.ERROR]:"error"},mS=(t,e,...n)=>{if(e<t.logLevel)return;const r=new Date().toISOString(),i=pS[e];if(i)console[i](`[${r}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Id{constructor(e){this.name=e,this._logLevel=fS,this._logHandler=mS,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ie))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?dS[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ie.DEBUG,...e),this._logHandler(this,ie.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ie.VERBOSE,...e),this._logHandler(this,ie.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ie.INFO,...e),this._logHandler(this,ie.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ie.WARN,...e),this._logHandler(this,ie.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ie.ERROR,...e),this._logHandler(this,ie.ERROR,...e)}}const gS=(t,e)=>e.some(n=>t instanceof n);let Rm,Pm;function yS(){return Rm||(Rm=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function _S(){return Pm||(Pm=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const mv=new WeakMap,rh=new WeakMap,gv=new WeakMap,Ju=new WeakMap,Sd=new WeakMap;function vS(t){const e=new Promise((n,r)=>{const i=()=>{t.removeEventListener("success",s),t.removeEventListener("error",o)},s=()=>{n(rr(t.result)),i()},o=()=>{r(t.error),i()};t.addEventListener("success",s),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&mv.set(n,t)}).catch(()=>{}),Sd.set(e,t),e}function wS(t){if(rh.has(t))return;const e=new Promise((n,r)=>{const i=()=>{t.removeEventListener("complete",s),t.removeEventListener("error",o),t.removeEventListener("abort",o)},s=()=>{n(),i()},o=()=>{r(t.error||new DOMException("AbortError","AbortError")),i()};t.addEventListener("complete",s),t.addEventListener("error",o),t.addEventListener("abort",o)});rh.set(t,e)}let ih={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return rh.get(t);if(e==="objectStoreNames")return t.objectStoreNames||gv.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return rr(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function ES(t){ih=t(ih)}function TS(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const r=t.call(Zu(this),e,...n);return gv.set(r,e.sort?e.sort():[e]),rr(r)}:_S().includes(t)?function(...e){return t.apply(Zu(this),e),rr(mv.get(this))}:function(...e){return rr(t.apply(Zu(this),e))}}function IS(t){return typeof t=="function"?TS(t):(t instanceof IDBTransaction&&wS(t),gS(t,yS())?new Proxy(t,ih):t)}function rr(t){if(t instanceof IDBRequest)return vS(t);if(Ju.has(t))return Ju.get(t);const e=IS(t);return e!==t&&(Ju.set(t,e),Sd.set(e,t)),e}const Zu=t=>Sd.get(t);function SS(t,e,{blocked:n,upgrade:r,blocking:i,terminated:s}={}){const o=indexedDB.open(t,e),l=rr(o);return r&&o.addEventListener("upgradeneeded",u=>{r(rr(o.result),u.oldVersion,u.newVersion,rr(o.transaction),u)}),n&&o.addEventListener("blocked",u=>n(u.oldVersion,u.newVersion,u)),l.then(u=>{s&&u.addEventListener("close",()=>s()),i&&u.addEventListener("versionchange",h=>i(h.oldVersion,h.newVersion,h))}).catch(()=>{}),l}const AS=["get","getKey","getAll","getAllKeys","count"],kS=["put","add","delete","clear"],ec=new Map;function xm(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(ec.get(e))return ec.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,i=kS.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||AS.includes(n)))return;const s=async function(o,...l){const u=this.transaction(o,i?"readwrite":"readonly");let h=u.store;return r&&(h=h.index(l.shift())),(await Promise.all([h[n](...l),i&&u.done]))[0]};return ec.set(e,s),s}ES(t=>({...t,get:(e,n,r)=>xm(e,n)||t.get(e,n,r),has:(e,n)=>!!xm(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class CS{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(RS(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function RS(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const sh="@firebase/app",Nm="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const An=new Id("@firebase/app"),PS="@firebase/app-compat",xS="@firebase/analytics-compat",NS="@firebase/analytics",DS="@firebase/app-check-compat",VS="@firebase/app-check",OS="@firebase/auth",bS="@firebase/auth-compat",LS="@firebase/database",MS="@firebase/data-connect",FS="@firebase/database-compat",jS="@firebase/functions",US="@firebase/functions-compat",zS="@firebase/installations",BS="@firebase/installations-compat",$S="@firebase/messaging",qS="@firebase/messaging-compat",HS="@firebase/performance",WS="@firebase/performance-compat",KS="@firebase/remote-config",GS="@firebase/remote-config-compat",QS="@firebase/storage",YS="@firebase/storage-compat",XS="@firebase/firestore",JS="@firebase/vertexai-preview",ZS="@firebase/firestore-compat",e1="firebase",t1="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oh="[DEFAULT]",n1={[sh]:"fire-core",[PS]:"fire-core-compat",[NS]:"fire-analytics",[xS]:"fire-analytics-compat",[VS]:"fire-app-check",[DS]:"fire-app-check-compat",[OS]:"fire-auth",[bS]:"fire-auth-compat",[LS]:"fire-rtdb",[MS]:"fire-data-connect",[FS]:"fire-rtdb-compat",[jS]:"fire-fn",[US]:"fire-fn-compat",[zS]:"fire-iid",[BS]:"fire-iid-compat",[$S]:"fire-fcm",[qS]:"fire-fcm-compat",[HS]:"fire-perf",[WS]:"fire-perf-compat",[KS]:"fire-rc",[GS]:"fire-rc-compat",[QS]:"fire-gcs",[YS]:"fire-gcs-compat",[XS]:"fire-fst",[ZS]:"fire-fst-compat",[JS]:"fire-vertex","fire-js":"fire-js",[e1]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qi=t1;function yv(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:oh,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw ir.create("bad-app-name",{appName:String(i)});if(n||(n=fv()),!n)throw ir.create("no-options");const s=io.get(i);if(s){if(dl(n,s.options)&&dl(r,s.config))return s;throw ir.create("duplicate-app",{appName:i})}const o=new hS(i);for(const u of ah.values())o.addComponent(u);const l=new s1(n,r,o);return io.set(i,l),l}function kd(t=oh){const e=io.get(t);if(!e&&t===oh&&fv())return yv();if(!e)throw ir.create("no-app",{appName:t});return e}function o1(){return Array.from(io.values())}function sr(t,e,n){var r;let i=(r=n1[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const l=[`Unable to register library "${i}" with version "${e}":`];s&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),An.warn(l.join(" "));return}Di(new jr(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const a1="firebase-heartbeat-database",l1=1,so="firebase-heartbeat-store";let tc=null;function _v(){return tc||(tc=SS(a1,l1,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(so)}catch(n){console.warn(n)}}}}).catch(t=>{throw ir.create("idb-open",{originalErrorMessage:t.message})})),tc}async function u1(t){try{const n=(await _v()).transaction(so),r=await n.objectStore(so).get(vv(t));return await n.done,r}catch(e){if(e instanceof Dn)An.warn(e.message);else{const n=ir.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});An.warn(n.message)}}}async function Vm(t,e){try{const r=(await _v()).transaction(so,"readwrite");await r.objectStore(so).put(e,vv(t)),await r.done}catch(n){if(n instanceof Dn)An.warn(n.message);else{const r=ir.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});An.warn(r.message)}}}function vv(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const c1=1024,h1=30*24*60*60*1e3;class d1{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new p1(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,n;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=Om();return((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)===null||n===void 0?void 0:n.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(o=>o.date===s)?void 0:(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(o=>{const l=new Date(o.date).valueOf();return Date.now()-l<=h1}),this._storage.overwrite(this._heartbeatsCache))}catch(r){An.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Om(),{heartbeatsToSend:r,unsentEntries:i}=f1(this._heartbeatsCache.heartbeats),s=hl(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(n){return An.warn(n),""}}}function Om(){return new Date().toISOString().substring(0,10)}function f1(t,e=c1){const n=[];let r=t.slice();for(const i of t){const s=n.find(o=>o.agent===i.agent);if(s){if(s.dates.push(i.date),bm(n)>e){s.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),bm(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class p1{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ZI()?eS().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await u1(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return Vm(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return Vm(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function bm(t){return hl(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function m1(t){Di(new jr("platform-logger",e=>new CS(e),"PRIVATE")),Di(new jr("heartbeat",e=>new d1(e),"PRIVATE")),sr(sh,Nm,t),sr(sh,Nm,"esm2017"),sr("fire-js","")}m1("");var g1="firebase",y1="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */sr(g1,y1,"app");var Lm=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kv{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class _1{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(it.UNAUTHENTICATED))}shutdown(){}}class v1{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class w1{constructor(e){this.t=e,this.currentUser=it.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){he(this.o===void 0);let r=this.i;const i=u=>this.i!==r?(r=this.i,n(u)):Promise.resolve();let s=new Vr;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new Vr,e.enqueueRetryable(()=>i(this.currentUser))};const o=()=>{const u=s;e.enqueueRetryable(async()=>{await u.promise,await i(this.currentUser)})},l=u=>{H("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(u=>l(u)),setTimeout(()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?l(u):(H("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new Vr)}},0),o()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(r=>this.i!==e?(H("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(he(typeof r.accessToken=="string"),new kv(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return he(e===null||typeof e=="string"),new it(e)}}class E1{constructor(e,n,r){this.l=e,this.h=n,this.P=r,this.type="FirstParty",this.user=it.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class T1{constructor(e,n,r){this.l=e,this.h=n,this.P=r}getToken(){return Promise.resolve(new E1(this.l,this.h,this.P))}start(e,n){e.enqueueRetryable(()=>n(it.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class I1{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class S1{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,n){he(this.o===void 0);const r=s=>{s.error!=null&&H("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${s.error.message}`);const o=s.token!==this.R;return this.R=s.token,H("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?n(s.token):Promise.resolve()};this.o=s=>{e.enqueueRetryable(()=>r(s))};const i=s=>{H("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=s,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(s=>i(s)),setTimeout(()=>{if(!this.appCheck){const s=this.A.getImmediate({optional:!0});s?i(s):H("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(he(typeof n.token=="string"),this.R=n.token,new I1(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eo(t){if(t.code!==b.FAILED_PRECONDITION||t.message!==x1)throw t;H("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pd(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function xd(t){const e=t.mapValue.fields.__previous_value__;return Pd(e)?xd(e):e}function ao(t){const e=hr(t.mapValue.fields.__local_write_time__.timestampValue);return new je(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nv{}class be extends Nv{constructor(e,n,r){super(),this.field=e,this.op=n,this.value=r}static create(e,n,r){return e.isKeyField()?n==="in"||n==="not-in"?this.createKeyFieldInFilter(e,n,r):new U1(e,n,r):n==="array-contains"?new $1(e,r):n==="in"?new q1(e,r):n==="not-in"?new H1(e,r):n==="array-contains-any"?new W1(e,r):new be(e,n,r)}static createKeyFieldInFilter(e,n,r){return n==="in"?new z1(e,r):new B1(e,r)}matches(e){const n=e.data.field(this.field);return this.op==="!="?n!==null&&this.matchesComparison(bi(n,this.value)):n!==null&&Br(this.value)===Br(n)&&this.matchesComparison(bi(n,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return J()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Qt extends Nv{constructor(e,n){super(),this.filters=e,this.op=n,this.ae=null}static create(e,n){return new Qt(e,n)}matches(e){return Dv(this)?this.filters.find(n=>!n.matches(e))===void 0:this.filters.find(n=>n.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,n)=>e.concat(n.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function Dv(t){return t.op==="and"}function Vv(t){return j1(t)&&Dv(t)}function j1(t){for(const e of t.filters)if(e instanceof Qt)return!1;return!0}function hh(t){if(t instanceof be)return t.field.canonicalString()+t.op.toString()+Li(t.value);if(Vv(t))return t.filters.map(e=>hh(e)).join(",");{const e=t.filters.map(n=>hh(n)).join(",");return`${t.op}(${e})`}}function Ov(t,e){return t instanceof be?function(r,i){return i instanceof be&&r.op===i.op&&r.field.isEqual(i.field)&&an(r.value,i.value)}(t,e):t instanceof Qt?function(r,i){return i instanceof Qt&&r.op===i.op&&r.filters.length===i.filters.length?r.filters.reduce((s,o,l)=>s&&Ov(o,i.filters[l]),!0):!1}(t,e):void J()}function bv(t){return t instanceof be?function(n){return`${n.field.canonicalString()} ${n.op} ${Li(n.value)}`}(t):t instanceof Qt?function(n){return n.op.toString()+" {"+n.getFilters().map(bv).join(" ,")+"}"}(t):"Filter"}class U1 extends be{constructor(e,n,r){super(e,n,r),this.key=W.fromName(r.referenceValue)}matches(e){const n=W.comparator(e.key,this.key);return this.matchesComparison(n)}}class z1 extends be{constructor(e,n){super(e,"in",n),this.keys=Lv("in",n)}matches(e){return this.keys.some(n=>n.isEqual(e.key))}}class B1 extends be{constructor(e,n){super(e,"not-in",n),this.keys=Lv("not-in",n)}matches(e){return!this.keys.some(n=>n.isEqual(e.key))}}function Lv(t,e){var n;return(((n=e.arrayValue)===null||n===void 0?void 0:n.values)||[]).map(r=>W.fromName(r.referenceValue))}class $1 extends be{constructor(e,n){super(e,"array-contains",n)}matches(e){const n=e.data.field(this.field);return Nd(n)&&uo(n.arrayValue,this.value)}}class q1 extends be{constructor(e,n){super(e,"in",n)}matches(e){const n=e.data.field(this.field);return n!==null&&uo(this.value.arrayValue,n)}}class H1 extends be{constructor(e,n){super(e,"not-in",n)}matches(e){if(uo(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const n=e.data.field(this.field);return n!==null&&!uo(this.value.arrayValue,n)}}class W1 extends be{constructor(e,n){super(e,"array-contains-any",n)}matches(e){const n=e.data.field(this.field);return!(!Nd(n)||!n.arrayValue.values)&&n.arrayValue.values.some(r=>uo(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const J1=new Ae(W.comparator);function Cn(){return J1}const Uv=new Ae(W.comparator);function Ss(...t){let e=Uv;for(const n of t)e=e.insert(n.key,n);return e}function zv(t){let e=Uv;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Rr(){return Fs()}function Bv(){return Fs()}function Fs(){return new Wi(t=>t.toString(),(t,e)=>t.isEqual(e))}const Z1=new Ae(W.comparator),eA=new Ge(W.comparator);function re(...t){let e=eA;for(const n of t)e=e.add(n);return e}const tA=new Ge(le);function nA(){return tA}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bd(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:fl(e)?"-0":e}}function $v(t){return{integerValue:""+t}}function rA(t,e){return V1(e)?$v(e):bd(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bA{constructor(e){this.ct=e}}function LA(t){const e=PA({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?ph(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class JA{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return JI()?8:D1(lt())>0?6:4}()}initialize(e,n){this.Ji=e,this.indexManager=n,this.Gi=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.Yi(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Zi(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new XA;return this.Xi(e,n,o).next(l=>{if(s.result=l,this.zi)return this.es(e,n,o,l.size)})}).next(()=>s.result)}es(e,n,r,i){return r.documentReadCount<this.ji?(_s()<=ie.DEBUG&&H("QueryEngine","SDK will not create cache indexes for query:",Zr(n),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),L.resolve()):(_s()<=ie.DEBUG&&H("QueryEngine","Query:",Zr(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Hi*i?(_s()<=ie.DEBUG&&H("QueryEngine","The SDK decides to create cache indexes for query:",Zr(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,nn(n))):L.resolve())}Yi(e,n){if(Gm(n))return L.resolve(null);let r=nn(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=ph(n,null,"F"),r=nn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=re(...s);return this.Ji.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const h=this.ts(n,l);return this.ns(n,h,o,u.readTime)?this.Yi(e,ph(n,null,"F")):this.rs(e,h,n,u)}))})))}Zi(e,n,r,i){return Gm(n)||i.isEqual(Z.min())?L.resolve(null):this.Ji.getDocuments(e,r).next(s=>{const o=this.ts(n,s);return this.ns(n,o,r,i)?L.resolve(null):(_s()<=ie.DEBUG&&H("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Zr(n)),this.rs(e,o,n,C1(i,-1)).next(l=>l))})}ts(e,n){let r=new Ge(jv(e));return n.forEach((i,s)=>{Wl(e,s)&&(r=r.add(s))}),r}ns(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Xi(e,n,r){return _s()<=ie.DEBUG&&H("QueryEngine","Using full collection scan to execute query:",Zr(n)),this.Ji.getDocumentsMatchingQuery(e,n,cr.min(),r)}rs(e,n,r,i){return this.Ji.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function RC(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(CC()||QI()||"connection"in navigator)?navigator.onLine:!0}function PC(){if(typeof navigator>"u")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Po{constructor(e,n){this.shortDelay=e,this.longDelay=n,Pn(n>e,"Short delay should be less than long delay!"),this.isMobile=WI()||YI()}get(){return RC()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tw(t,e=[]){let n;switch(t){case"Browser":n=Pg(lt());break;case"Worker":n=`${Pg(lt())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${qi}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qC(t,e={}){return Qi(t,"GET","/v2/passwordPolicy",xo(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Si(t,e){return df(t,"POST","/v1/accounts:signInWithIdp",xo(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function iR(t,e){return df(t,"POST","/v1/accounts:signUp",xo(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function aR(t,e,n=!1){const{auth:r}=t;if(Zt(r.app))return Promise.reject(wn(r));const i="reauthenticate";try{const s=await fo(t,sw(r,i,e,t),n);X(s.idToken,r,"internal-error");const o=ff(s.idToken);X(o,r,"internal-error");const{sub:l}=o;return X(t.uid===l,r,"user-mismatch"),xn._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&Rn(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lR(t,e,n=!1){if(Zt(t.app))return Promise.reject(wn(t));const r="signIn",i=await sw(t,r,e),s=await xn._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uR(t,e){return df(t,"POST","/v1/accounts:signInWithCustomToken",xo(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PR(t,e){return e?_n(e):(X(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pw{constructor(e,n,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:i,tenantId:s,error:o,type:l}=e;if(o){this.reject(o);return}const u={auth:this.auth,requestUri:n,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(u))}catch(h){this.reject(h)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return xR;case"linkViaPopup":case"linkViaRedirect":return DR;case"reauthViaPopup":case"reauthViaRedirect":return NR;default:Rn(this.auth,"internal-error")}}resolve(e){Pn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Pn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OR="pendingRedirect",ja=new Map;class bR extends pw{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=ja.get(this.auth._key());if(!e){try{const r=await LR(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}ja.set(this.auth._key(),e)}return this.bypassAuthState||ja.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function LR(t,e){const n=jR(e),r=FR(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function MR(t,e){ja.set(t._key(),e)}function FR(t){return _n(t._redirectPersistence)}function jR(t){return Fa(OR,t.config.apiKey,t.name)}async function UR(t,e,n=!1){if(Zt(t.app))return Promise.reject(wn(t));const r=No(t),i=PR(r,e),o=await new bR(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JR=new Po(5e3,15e3),ZR="__/auth/iframe",eP="emulator/auth/iframe",tP={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},nP=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function rP(t){const e=t.config;X(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?hf(e,eP):`https://${t.config.authDomain}/${ZR}`,r={apiKey:e.apiKey,appName:t.name,v:qi},i=nP.get(t.config.apiHost);i&&(r.eid=i);const s=t._getFrameworks();return s.length&&(r.fw=s.join(",")),`${n}?${wo(r).slice(1)}`}async function iP(t){const e=await XR(t),n=on().gapi;return X(n,t,"internal-error"),e.open({where:document.body,url:rP(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:tP,dontclear:!0},r=>new Promise(async(i,s)=>{await r.restyle({setHideOnLeave:!1});const o=sn(t,"network-request-failed"),l=on().setTimeout(()=>{s(o)},JR.get());function u(){on().clearTimeout(l),i(r)}r.ping(u).then(u,()=>{s(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sP={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},oP=500,aP=600,lP="_blank",uP="http://localhost";class Mg{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function cP(t,e,n,r=oP,i=aP){const s=Math.max((window.screen.availHeight-i)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let l="";const u=Object.assign(Object.assign({},sP),{width:r.toString(),height:i.toString(),top:s,left:o}),h=lt().toLowerCase();n&&(l=Q0(h)?lP:n),K0(h)&&(e=e||uP,u.scrollbars="yes");const f=Object.entries(u).reduce((y,[k,x])=>`${y}${k}=${x},`,"");if(zC(h)&&l!=="_self")return hP(e||"",l),new Mg(null);const m=window.open(e||"",l,f);X(m,t,"popup-blocked");try{m.focus()}catch{}return new Mg(m)}function hP(t,e){const n=document.createElement("a");n.href=t,n.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dP="__/auth/handler",fP="emulator/auth/handler",pP=encodeURIComponent("fac");async function Fg(t,e,n,r,i,s){X(t.config.authDomain,t,"auth-domain-config-required"),X(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:qi,eventId:i};if(e instanceof iw){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",iS(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,m]of Object.entries({}))o[f]=m}if(e instanceof Do){const f=e.getScopes().filter(m=>m!=="");f.length>0&&(o.scopes=f.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const u=await t._getAppCheckToken(),h=u?`#${pP}=${encodeURIComponent(u)}`:"";return`${mP(t)}?${wo(l).slice(1)}${h}`}function mP({config:t}){return t.emulator?hf(t,fP):`https://${t.authDomain}/${dP}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lc="webStorageSupport";class gP{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=uw,this._completeRedirectFn=UR,this._overrideRedirectResult=MR}async _openPopup(e,n,r,i){var s;Pn((s=this.eventManagers[e._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const o=await Fg(e,n,r,Ah(),i);return cP(e,o,gf())}async _openRedirect(e,n,r,i){await this._originValidation(e);const s=await Fg(e,n,r,Ah(),i);return vR(s),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:i,promise:s}=this.eventManagers[n];return i?Promise.resolve(i):(Pn(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[n]={promise:r},r.catch(()=>{delete this.eventManagers[n]}),r}async initAndGetManager(e){const n=await iP(e),r=new BR(e);return n.register("authEvent",i=>(X(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=n,r}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(lc,{type:lc},i=>{var s;const o=(s=i==null?void 0:i[0])===null||s===void 0?void 0:s[lc];o!==void 0&&n(!!o),Rn(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=KR(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return ew()||G0()||pf()}}const yP=gP;var jg="@firebase/auth",Ug="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vP(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function wP(t){Di(new jr("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:o,authDomain:l}=r.options;X(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const u={apiKey:o,authDomain:l,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:tw(t)},h=new KC(r,i,s,u);return ZC(h,n),h},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),Di(new jr("auth-internal",e=>{const n=No(e.getProvider("auth").getImmediate());return(r=>new _P(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),sr(jg,Ug,vP(t)),sr(jg,Ug,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const EP=5*60,TP=pv("authIdTokenMaxAge")||EP;let zg=null;const IP=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>TP)return;const i=n==null?void 0:n.token;zg!==i&&(zg=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function SP(t=kd()){const e=Ad(t,"auth");if(e.isInitialized())return e.getImmediate();const n=JC(t,{popupRedirectResolver:yP,persistence:[RR,gR,uw]}),r=pv("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(r,location.origin);if(location.origin===s.origin){const o=IP(s.toString());dR(n,o,()=>o(n.currentUser)),hR(n,l=>o(l))}}const i=dv("auth");return i&&eR(n,`http://${i}`),n}function AP(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}GC({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=i=>{const s=sn("internal-error");s.customData=i,n(s)},r.type="text/javascript",r.charset="UTF-8",AP().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});wP("Browser");const Pr=({children:t,className:e=""})=>T.jsx("div",{className:`bg-slate-800 border border-slate-700 rounded-xl p-4 shadow-sm ${e}`,children:t}),bt=({children:t,onClick:e,variant:n="primary",className:r="",icon:i,disabled:s=!1,fullWidth:o=!1})=>{const l={primary:"bg-indigo-600 hover:bg-indigo-500 text-white",secondary:"bg-slate-700 hover:bg-slate-600 text-slate-200",danger:"bg-red-500/20 hover:bg-red-500/30 text-red-400 border border-red-500/50",ghost:"hover:bg-slate-700 text-slate-400 hover:text-white",outline:"border border-slate-600 text-slate-300 hover:bg-slate-800"};return T.jsxs("button",{onClick:e,disabled:s,className:`flex items-center justify-center gap-2 px-4 py-2 rounded-lg transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed ${l[n]} ${o?"w-full":""} ${r}`,children:[i&&T.jsx(i,{size:18}),t]})},Bg=({value:t,onChange:e,label:n="Intensità"})=>{const r=l=>l<=3?{color:"text-emerald-400",bg:"bg-emerald-500",icon:DI,label:"Lieve"}:l<=5?{color:"text-yellow-400",bg:"bg-yellow-500",icon:RI,label:"Moderato"}:l<=7?{color:"text-orange-400",bg:"bg-orange-500",icon:CI,label:"Forte"}:l<=9?{color:"text-rose-400",bg:"bg-rose-500",icon:TI,label:"Molto Forte"}:{color:"text-red-500",bg:"bg-red-600",icon:EI,label:"Insopportabile"},{color:i,bg:s,icon:o}=r(t);return T.jsxs("div",{className:"space-y-4 py-2",children:[T.jsxs("div",{className:"flex flex-col items-center justify-center animate-fade-in",children:[T.jsx(o,{size:32,className:`${i} mb-1 transition-colors duration-300`}),T.jsx("span",{className:`text-2xl font-bold ${i} transition-colors duration-300`,children:t}),T.jsx("span",{className:"text-xs text-slate-400 uppercase tracking-widest",children:n})]}),T.jsx("input",{type:"range",min:"1",max:"10",value:t,onChange:l=>e(parseInt(l.target.value)),className:"w-full h-3 rounded-lg appearance-none cursor-pointer bg-slate-700",style:{accentColor:t<=3?"#34d399":t<=5?"#facc15":t<=7?"#fb923c":t<=9?"#fb7185":"#ef4444"}}),T.jsxs("div",{className:"flex justify-between text-xs text-slate-500 font-medium",children:[T.jsx("span",{children:"1 - Lieve"}),T.jsx("span",{children:"10 - Estremo"})]})]})},kP=({selectedAuras:t,customAura:e,onChange:n})=>{const r=[{label:"Visiva",color:"bg-blue-600 border-blue-500 text-white"},{label:"Sensitiva",color:"bg-purple-600 border-purple-500 text-white"},{label:"Linguaggio",color:"bg-pink-600 border-pink-500 text-white"},{label:"Motoria",color:"bg-orange-600 border-orange-500 text-white"},{label:"Vertigini",color:"bg-teal-600 border-teal-500 text-white"}],i=s=>{t.includes(s)?n(t.filter(o=>o!==s),e):n([...t,s],e)};return T.jsxs("div",{className:"space-y-3 animate-fade-in",children:[T.jsx("label",{className:"text-sm font-medium text-slate-400 block",children:"Seleziona tipi di Aura:"}),T.jsx("div",{className:"flex flex-wrap gap-2",children:r.map(s=>{const o=t.includes(s.label);return T.jsxs("button",{onClick:()=>i(s.label),className:`px-3 py-1.5 rounded-full text-sm font-medium border transition-all flex items-center gap-1.5 shadow-sm
                ${o?`${s.color} shadow-lg scale-105`:"bg-slate-800 border-slate-600 text-slate-400 hover:border-slate-500 hover:text-slate-200"}`,children:[o&&T.jsx(SI,{size:14}),s.label]},s.label)})}),T.jsx("div",{className:"relative mt-2",children:T.jsx("input",{type:"text",placeholder:"Altro tipo di aura (es. confusione...)",value:e,onChange:s=>n(t,s.target.value),className:"w-full bg-slate-800 border border-slate-700 rounded-lg py-3 px-3 text-white text-sm focus:ring-2 focus:ring-indigo-500 outline-none placeholder:text-slate-600"})})]})},CP=({formData:t,setFormData:e,onCancel:n,onSubmit:r,isSaving:i,editingId:s})=>{const o=()=>{e({...t,medications:[...t.medications||[],{name:"",dosage:""}]})},l=h=>{const f=[...t.medications||[]];f.splice(h,1),e({...t,medications:f})},u=(h,f,m)=>{const y=[...t.medications||[]];y[h]={...y[h],[f]:m},e({...t,medications:y})};return T.jsxs("div",{className:"space-y-6 animate-fade-in pb-20",children:[T.jsxs("div",{className:"flex items-center gap-4 mb-6",children:[T.jsx("button",{onClick:n,className:"p-2 hover:bg-slate-700 rounded-full",children:T.jsx(Td,{className:"text-slate-300"})}),T.jsx("h2",{className:"text-xl font-bold text-white",children:s?"Modifica Registrazione":"Nuova Registrazione"})]}),T.jsxs(Pr,{className:"space-y-6",children:[T.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[T.jsxs("div",{className:"space-y-2",children:[T.jsx("label",{className:"text-sm font-medium text-slate-400",children:"Data *"}),T.jsxs("div",{className:"relative",children:[T.jsx(II,{className:"absolute left-3 top-2.5 text-slate-500",size:18}),T.jsx("input",{type:"date",required:!0,value:t.date,onChange:h=>e({...t,date:h.target.value}),className:"w-full bg-slate-900 border border-slate-700 rounded-lg py-2 pl-10 pr-3 text-white focus:ring-2 focus:ring-indigo-500 outline-none"})]})]}),T.jsxs("div",{className:"space-y-2",children:[T.jsx("label",{className:"text-sm font-medium text-slate-400",children:"Ora Inizio"}),T.jsxs("div",{className:"relative",children:[T.jsx(tv,{className:"absolute left-3 top-2.5 text-slate-500",size:18}),T.jsx("input",{type:"time",value:t.time,onChange:h=>e({...t,time:h.target.value}),className:"w-full bg-slate-900 border border-slate-700 rounded-lg py-2 pl-10 pr-3 text-white focus:ring-2 focus:ring-indigo-500 outline-none"})]})]})]}),T.jsxs("div",{className:"space-y-2",children:[T.jsx("label",{className:"text-sm font-medium text-slate-400",children:"Durata (Ore)"}),T.jsx("input",{type:"number",placeholder:"Es. 4",value:t.duration,onChange:h=>e({...t,duration:h.target.value}),className:"w-full bg-slate-900 border border-slate-700 rounded-lg py-2 px-3 text-white focus:ring-2 focus:ring-indigo-500 outline-none"})]}),T.jsxs("div",{className:"space-y-2 bg-slate-900/30 p-4 rounded-xl border border-slate-700/30",children:[T.jsx("label",{className:"text-sm font-medium text-slate-400 text-center block mb-2",children:"Intensità del Dolore"}),T.jsx(Bg,{value:t.intensity,onChange:h=>e({...t,intensity:h}),label:"Intensità Iniziale"})]}),T.jsxs("div",{className:"bg-slate-900/50 p-4 rounded-lg space-y-4 border border-teal-500/20",children:[T.jsxs("div",{className:"flex items-center justify-between",children:[T.jsxs("div",{className:"flex items-center gap-2",children:[T.jsx(nh,{className:`text-${t.tookMedication?"teal-400":"slate-500"}`,size:20}),T.jsx("label",{className:"text-white font-medium",children:"Ho preso farmaci?"})]}),T.jsxs("label",{className:"relative inline-flex items-center cursor-pointer",children:[T.jsx("input",{type:"checkbox",className:"sr-only peer",checked:t.tookMedication,onChange:h=>e({...t,tookMedication:h.target.checked})}),T.jsx("div",{className:"w-11 h-6 bg-slate-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-teal-600"})]})]}),t.tookMedication&&T.jsxs("div",{className:"animate-fade-in space-y-4 pt-2 border-t border-slate-800",children:[T.jsxs("div",{className:"space-y-3",children:[T.jsx("label",{className:"text-xs font-medium text-slate-400 uppercase",children:"Farmaci Assunti"}),(t.medications||[]).map((h,f)=>T.jsxs("div",{className:"flex gap-2 items-start animate-fade-in",children:[T.jsx("input",{type:"text",placeholder:"Nome Farmaco (es. Oki)",value:h.name,onChange:m=>u(f,"name",m.target.value),className:"flex-[2] min-w-0 bg-slate-800 border border-slate-700 rounded-lg py-2 px-3 text-white text-sm focus:ring-2 focus:ring-teal-500 outline-none"}),T.jsx("input",{type:"text",placeholder:"Dose (es. 1 bust)",value:h.dosage,onChange:m=>u(f,"dosage",m.target.value),className:"flex-1 min-w-0 bg-slate-800 border border-slate-700 rounded-lg py-2 px-3 text-white text-sm focus:ring-2 focus:ring-teal-500 outline-none"}),T.jsx("button",{onClick:()=>l(f),className:"shrink-0 p-2 text-slate-500 hover:text-red-400 hover:bg-slate-800 rounded",children:T.jsx(av,{size:16})})]},f)),T.jsx(bt,{onClick:o,variant:"outline",className:"w-full border-dashed border-slate-600 text-slate-400 text-xs py-1",icon:iv,children:"Aggiungi Farmaco"})]}),T.jsxs("div",{className:"space-y-2 pt-2 border-t border-slate-800/50 mt-4",children:[T.jsx("label",{className:"text-xs font-medium text-slate-400 uppercase text-center block",children:"Intensità dopo farmaco"}),T.jsx(Bg,{value:t.intensityAfterMeds,onChange:h=>e({...t,intensityAfterMeds:h}),label:"Post-Farmaco"})]})]})]}),T.jsxs("div",{className:"bg-slate-900/50 p-4 rounded-lg space-y-4 border border-indigo-500/20",children:[T.jsxs("div",{className:"flex items-center justify-between",children:[T.jsxs("div",{className:"flex items-center gap-2",children:[T.jsx(lv,{className:`text-${t.hasAura?"yellow-400":"slate-500"}`,size:20}),T.jsx("label",{className:"text-white font-medium",children:"Aura presente?"})]}),T.jsxs("label",{className:"relative inline-flex items-center cursor-pointer",children:[T.jsx("input",{type:"checkbox",className:"sr-only peer",checked:t.hasAura,onChange:h=>e({...t,hasAura:h.target.checked})}),T.jsx("div",{className:"w-11 h-6 bg-slate-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600"})]})]}),t.hasAura&&T.jsx(kP,{selectedAuras:t.auraTypes,customAura:t.customAura,onChange:(h,f)=>e({...t,auraTypes:h,customAura:f})})]}),T.jsxs("div",{className:"space-y-2",children:[T.jsx("label",{className:"text-sm font-medium text-slate-400",children:"Note Aggiuntive"}),T.jsx("textarea",{rows:"3",value:t.notes,onChange:h=>e({...t,notes:h.target.value}),className:"w-full bg-slate-900 border border-slate-700 rounded-lg py-2 px-3 text-white focus:ring-2 focus:ring-indigo-500 outline-none resize-none",placeholder:"Fattori scatenanti, farmaci presi, sintomi..."})]}),T.jsxs("div",{className:"flex gap-2",children:[T.jsx(bt,{onClick:n,variant:"secondary",className:"flex-1",children:"Annulla"}),T.jsx(bt,{onClick:r,className:"flex-[2] py-3",icon:i?null:xI,disabled:i,children:i?"Salvataggio...":"Salva Diario"})]})]})]})},RP=({logs:t,filteredLogs:e,totalLogs:n,totalLogsAllTime:r,avgIntensity:i,logsWithAura:s,auraPercentage:o,onSettings:l,onReport:u,onNewEntry:h,dateFilter:f,setDateFilter:m,isCloudMode:y,onEdit:k,onDelete:x,renderAuraString:D,getAuraBadgeColor:O})=>T.jsxs("div",{className:"space-y-6 pb-24",children:[T.jsxs("header",{className:"flex justify-between items-center mb-2",children:[T.jsxs("div",{children:[T.jsx("h1",{className:"text-2xl font-bold text-white tracking-tight",children:"Emicrania Log"}),T.jsx("div",{className:"flex items-center gap-2 text-sm mt-1",children:y?T.jsxs("span",{className:"flex items-center gap-1 text-emerald-400 bg-emerald-950/30 px-2 py-0.5 rounded-full border border-emerald-500/20",children:[T.jsx(nv,{size:12})," Sync Attivo"]}):T.jsxs("span",{className:"flex items-center gap-1 text-slate-400 bg-slate-800 px-2 py-0.5 rounded-full border border-slate-700",children:[T.jsx(ov,{size:12})," Locale (Offline)"]})})]}),T.jsx("button",{onClick:l,className:"p-2 bg-slate-800 rounded-full hover:bg-slate-700 text-slate-300",children:T.jsx(sv,{size:20})})]}),T.jsxs("div",{className:"bg-slate-800/50 p-3 rounded-lg border border-slate-700/50 flex flex-col gap-2",children:[T.jsxs("div",{className:"flex items-center gap-2 text-slate-300 text-sm mb-1",children:[T.jsx(kI,{size:14}),T.jsx("span",{className:"font-semibold",children:"Filtra Periodo"})]}),T.jsxs("div",{className:"flex gap-2",children:[T.jsx("input",{type:"date",value:f.start,onChange:w=>m({...f,start:w.target.value}),className:"bg-slate-900 border border-slate-700 text-white text-xs rounded px-2 py-2 w-full outline-none focus:border-indigo-500",placeholder:"Dal"}),T.jsx("input",{type:"date",value:f.end,onChange:w=>m({...f,end:w.target.value}),className:"bg-slate-900 border border-slate-700 text-white text-xs rounded px-2 py-2 w-full outline-none focus:border-indigo-500",placeholder:"Al"}),(f.start||f.end)&&T.jsx("button",{onClick:()=>m({start:"",end:""}),className:"px-3 bg-slate-700 rounded text-slate-300 hover:text-white",children:T.jsx(bI,{size:14})})]})]}),T.jsxs("div",{className:"grid grid-cols-3 gap-3",children:[T.jsxs(Pr,{className:"flex flex-col items-center justify-center py-4 px-2 bg-gradient-to-br from-slate-800 to-slate-900",children:[T.jsx("span",{className:"text-slate-400 text-[10px] uppercase tracking-wider mb-1 text-center",children:"Episodi"}),T.jsx("span",{className:"text-white font-bold text-xl",children:n}),(f.start||f.end)&&T.jsx("span",{className:"text-[10px] text-slate-500",children:"nel periodo"})]}),T.jsxs(Pr,{className:"flex flex-col items-center justify-center py-4 px-2 bg-gradient-to-br from-slate-800 to-slate-900",children:[T.jsx("span",{className:"text-slate-400 text-[10px] uppercase tracking-wider mb-1 text-center",children:"% Aura"}),T.jsxs("span",{className:"text-white font-bold text-xl",children:[o,"%"]}),T.jsxs("span",{className:"text-[10px] text-slate-500",children:[s," casi"]})]}),T.jsxs(Pr,{className:"flex flex-col items-center justify-center py-4 px-2 bg-gradient-to-br from-slate-800 to-slate-900",children:[T.jsx("span",{className:"text-slate-400 text-[10px] uppercase tracking-wider mb-1 text-center",children:"Dolore"}),T.jsx("div",{className:"flex items-center gap-1",children:T.jsx("span",{className:`font-bold text-xl ${i>6?"text-rose-500":"text-emerald-500"}`,children:i})}),T.jsx("span",{className:"text-[10px] text-slate-500",children:"media"})]})]}),T.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[T.jsx(bt,{variant:"secondary",icon:rv,onClick:u,children:"Report Medico"}),T.jsx(bt,{variant:"primary",icon:iv,onClick:h,children:"Nuovo Diario"})]}),T.jsxs("div",{className:"space-y-4",children:[T.jsxs("div",{className:"flex justify-between items-end",children:[T.jsx("h3",{className:"text-lg font-semibold text-white",children:f.start||f.end?"Diario (Filtrato)":"Diario Completo"}),T.jsxs("span",{className:"text-xs text-slate-500",children:[n," di ",r," totali"]})]}),n===0?T.jsxs("div",{className:"text-center py-10 text-slate-500 bg-slate-900/50 rounded-xl border border-dashed border-slate-800",children:[T.jsx(NI,{className:"mx-auto mb-2 opacity-50",size:32}),T.jsx("p",{children:"Nessun diario trovato."}),(f.start||f.end)&&T.jsx("p",{className:"text-xs mt-1",children:"Prova a modificare le date del filtro."})]}):e.map(w=>T.jsxs(Pr,{className:"relative group overflow-hidden border-l-4",style:{borderLeftColor:w.intensity<=3?"#10b981":w.intensity<=6?"#f59e0b":"#e11d48"},children:[T.jsxs("div",{className:"flex justify-between items-start mb-2",children:[T.jsxs("div",{children:[T.jsxs("div",{className:"flex items-center gap-2",children:[T.jsx("span",{className:"text-white font-semibold text-lg",children:new Date(w.date).toLocaleDateString("it-IT",{weekday:"short",day:"numeric",month:"long"})}),w.hasAura&&T.jsxs("div",{className:"flex gap-1 flex-wrap mt-1",children:[Array.isArray(w.auraTypes)&&w.auraTypes.map(v=>T.jsxs("span",{className:`text-[10px] px-2 py-0.5 rounded-full border flex items-center gap-1 ${O(v)}`,children:[T.jsx(lv,{size:8})," ",v]},v)),(!Array.isArray(w.auraTypes)||w.auraTypes.length===0)&&T.jsx("span",{className:"bg-slate-700 text-slate-300 text-[10px] px-2 py-0.5 rounded-full",children:"Aura"})]})]}),T.jsxs("div",{className:"text-slate-400 text-sm flex items-center gap-2 mt-1",children:[T.jsx(tv,{size:12})," ",w.time," ",w.duration&&T.jsxs("span",{children:["• ",w.duration,"h"]})]}),w.tookMedication&&T.jsxs("div",{className:"flex flex-col gap-1 mt-2",children:[(w.medications||[]).length>0?w.medications.map((v,A)=>T.jsxs("div",{className:"flex items-center gap-2 text-xs text-teal-400 bg-teal-900/20 px-2 py-1 rounded w-fit border border-teal-500/20",children:[T.jsx(nh,{size:12}),T.jsxs("span",{children:[v.name||"Farmaco"," ",v.dosage&&`(${v.dosage})`]})]},A)):w.medicationName&&T.jsxs("div",{className:"flex items-center gap-2 text-xs text-teal-400 bg-teal-900/20 px-2 py-1 rounded w-fit border border-teal-500/20",children:[T.jsx(nh,{size:12}),T.jsxs("span",{children:[w.medicationName," ",w.medicationDosage&&`(${w.medicationDosage})`]})]}),w.intensityAfterMeds>0&&T.jsxs("span",{className:"text-[10px] text-teal-500/70 ml-1",children:["Post: ",w.intensityAfterMeds]})]})]}),T.jsx("div",{className:`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm shadow-sm ${w.intensity<=3?"bg-emerald-500 text-emerald-950":w.intensity<=6?"bg-amber-500 text-amber-950":"bg-rose-500 text-rose-950"}`,children:w.intensity})]}),w.notes&&T.jsxs("p",{className:"text-slate-500 text-sm mt-2 line-clamp-2 italic border-t border-slate-700/50 pt-2",children:['"',w.notes,'"']}),T.jsxs("div",{className:"absolute bottom-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity",children:[T.jsx("button",{onClick:()=>k(w),className:"text-slate-500 hover:text-indigo-400 bg-slate-900/80 p-1.5 rounded-full",children:T.jsx(VI,{size:16})}),T.jsx("button",{onClick:()=>x(w.id),className:"text-slate-500 hover:text-red-400 bg-slate-900/80 p-1.5 rounded-full",children:T.jsx(av,{size:16})})]})]},w.id))]})]}),PP=({onBack:t,isCloudMode:e,customConfigJson:n,setCustomConfigJson:r,onSaveConfig:i,onClearConfig:s,isUsingCustomConfig:o,onExportJSON:l,onImportClick:u,isSaving:h,fileInputRef:f,onFileImport:m})=>T.jsxs("div",{className:"space-y-6 pb-20",children:[T.jsxs("div",{className:"flex items-center gap-4 mb-6",children:[T.jsx("button",{onClick:t,className:"p-2 hover:bg-slate-700 rounded-full",children:T.jsx(Td,{className:"text-slate-300"})}),T.jsx("h2",{className:"text-xl font-bold text-white",children:"Impostazioni"})]}),T.jsxs("div",{className:"space-y-6",children:[T.jsxs(Pr,{className:"space-y-4 border-indigo-500/30 relative overflow-hidden",children:[T.jsxs("div",{className:"flex items-center gap-2 text-indigo-400 relative z-10",children:[T.jsx(sv,{size:20}),T.jsx("h3",{className:"font-semibold",children:"Sincronizzazione Cloud"})]}),T.jsxs("div",{className:`text-xs px-3 py-2 rounded border mb-2 flex items-center gap-2 ${e?"bg-emerald-900/30 border-emerald-500/30 text-emerald-300":"bg-slate-700/50 border-slate-600 text-slate-300"}`,children:[e?T.jsx(nv,{size:14}):T.jsx(ov,{size:14}),e?"STATO: CONNESSO A FIREBASE":"STATO: MODALITÀ LOCALE (OFFLINE)"]}),T.jsx("p",{className:"text-sm text-slate-400",children:"Incolla qui il JSON di configurazione Firebase per attivare il sync. Se vuoto, i dati verranno salvati solo su questo dispositivo (Local Storage)."}),T.jsx("textarea",{className:"w-full bg-slate-900 border border-slate-700 rounded p-2 text-xs text-slate-300 font-mono",rows:"6",placeholder:'{ "apiKey": "...", "authDomain": "..." }',value:n,onChange:y=>r(y.target.value)}),T.jsxs("div",{className:"flex gap-2",children:[T.jsx(bt,{onClick:i,className:"w-full",children:e?"Aggiorna Config":"Attiva Cloud"}),o&&T.jsx(bt,{onClick:s,variant:"danger",children:"Disconnetti"})]})]}),T.jsxs(Pr,{className:"space-y-4",children:[T.jsx("h3",{className:"font-semibold text-white",children:"Gestione Dati"}),T.jsxs("p",{className:"text-xs text-slate-400",children:["Stai operando in modalità ",T.jsx("strong",{children:e?"Cloud":"Locale"}),". Import ed Export avverranno sul database attivo."]}),T.jsxs("div",{className:"flex flex-col gap-3",children:[T.jsx(bt,{variant:"outline",icon:AI,onClick:l,children:"Esporta Backup (JSON)"}),T.jsx(bt,{variant:"outline",icon:OI,onClick:u,disabled:h,children:h?"Importazione...":"Importa Backup (JSON)"}),T.jsx("input",{type:"file",ref:f,className:"hidden",accept:".json",onChange:m})]})]})]})]}),xP=({logs:t,filteredLogs:e,dateFilter:n,onBack:r,onExportCSV:i,onPrint:s,renderAuraString:o})=>{const l=e,u=l.length,h=u>0?(l.reduce((f,m)=>f+parseInt(m.intensity),0)/u).toFixed(1):0;return T.jsxs("div",{className:"bg-white min-h-screen text-black absolute top-0 left-0 w-full z-50 p-8",children:[T.jsxs("div",{className:"flex justify-between items-start mb-8 print:hidden",children:[T.jsx(bt,{variant:"secondary",onClick:r,icon:Td,children:"Torna all'App"}),T.jsxs("div",{className:"flex gap-2",children:[T.jsx(bt,{variant:"primary",icon:rv,onClick:i,children:"Scarica Excel (CSV)"}),T.jsx(bt,{variant:"outline",icon:PI,onClick:s,children:"Stampa PDF"})]})]}),T.jsxs("div",{className:"print-section max-w-4xl mx-auto",children:[T.jsxs("div",{className:"mb-8 border-b border-gray-300 pb-4",children:[T.jsx("h1",{className:"text-3xl font-bold text-gray-900",children:"Diario Emicrania"}),T.jsxs("p",{className:"text-gray-600 mt-2",children:["Report generato il ",new Date().toLocaleDateString("it-IT")," ",(n.start||n.end)&&T.jsxs("span",{className:"block mt-1 font-semibold text-indigo-700",children:["Periodo: ",n.start||"Inizio"," - ",n.end||"Oggi"]})]}),T.jsxs("div",{className:"flex gap-8 mt-4",children:[T.jsxs("div",{children:[T.jsx("span",{className:"block text-xs text-gray-500 uppercase",children:"Totale Episodi"}),T.jsx("span",{className:"text-xl font-bold",children:u})]}),T.jsxs("div",{children:[T.jsx("span",{className:"block text-xs text-gray-500 uppercase",children:"Media Intensità"}),T.jsxs("span",{className:"text-xl font-bold",children:[h,"/10"]})]})]})]}),T.jsxs("table",{className:"w-full text-left text-sm",children:[T.jsx("thead",{children:T.jsxs("tr",{className:"border-b-2 border-gray-800",children:[T.jsx("th",{className:"py-2 font-bold",children:"Data"}),T.jsx("th",{className:"py-2 font-bold",children:"Ora"}),T.jsx("th",{className:"py-2 font-bold",children:"Durata"}),T.jsx("th",{className:"py-2 font-bold",children:"Intensità"}),T.jsx("th",{className:"py-2 font-bold",children:"Aura"}),T.jsx("th",{className:"py-2 font-bold",children:"Farmaci"}),T.jsx("th",{className:"py-2 font-bold",children:"Note"})]})}),T.jsx("tbody",{children:l.map(f=>T.jsxs("tr",{className:"border-b border-gray-200",children:[T.jsx("td",{className:"py-3 pr-2",children:new Date(f.date).toLocaleDateString("it-IT")}),T.jsx("td",{className:"py-3 pr-2",children:f.time}),T.jsx("td",{className:"py-3 pr-2",children:f.duration?`${f.duration}h`:"-"}),T.jsx("td",{className:"py-3 pr-2",children:T.jsx("span",{className:`font-bold px-2 py-1 rounded text-xs text-white ${f.intensity<=3?"bg-emerald-600":f.intensity<=6?"bg-amber-600":"bg-rose-600"}`,children:f.intensity})}),T.jsx("td",{className:"py-3 pr-2 max-w-[150px]",children:f.hasAura?T.jsx("span",{className:"text-purple-700 font-semibold text-xs",children:o(f)}):T.jsx("span",{className:"text-gray-400",children:"-"})}),T.jsxs("td",{className:"py-3 pr-2 text-xs",children:[f.tookMedication?(f.medications||[]).length>0?f.medications.map((m,y)=>T.jsxs("div",{children:[m.name," ",m.dosage&&`(${m.dosage})`]},y)):`${f.medicationName||"Sì"} ${f.medicationDosage?`(${f.medicationDosage})`:""}`:"-",f.tookMedication&&f.intensityAfterMeds>0&&T.jsxs("div",{className:"text-gray-500 mt-1",children:["Post: ",f.intensityAfterMeds]})]}),T.jsx("td",{className:"py-3 text-gray-600 italic max-w-xs",children:f.notes||"-"})]},f.id))})]}),T.jsx("div",{className:"mt-8 text-xs text-gray-400 border-t pt-4",children:"Documento generato da Emicrania Log - Uso strettamente personale. Consultare un medico per diagnosi."})]}),T.jsx("style",{children:"@media print { body { background: white; color: black; } .print:hidden { display: none !important; } .print-section { width: 100%; margin: 0; } }"})]})};function NP(){const[t,e]=xe.useState("dashboard"),[n,r]=xe.useState([]),[i,s]=xe.useState(null),[o,l]=xe.useState(!0),[u,h]=xe.useState(!1),[f,m]=xe.useState(!1),[y,k]=xe.useState(null),[x,D]=xe.useState({start:"",end:""}),[O,w]=xe.useState(""),[v,A]=xe.useState(!1),V=xe.useRef(null),U={date:new Date().toISOString().split("T")[0],time:new Date().toLocaleTimeString("it-IT",{hour:"2-digit",minute:"2-digit"}),duration:"",intensity:5,hasAura:!1,auraTypes:[],customAura:"",notes:"",tookMedication:!1,medications:[],intensityAfterMeds:0},[M,E]=xe.useState(U);xe.useEffect(()=>{(async()=>{const K=localStorage.getItem("migraine_firebase_config");let Q=null,G=!1;if(K)try{Q=JSON.parse(K),w(K),G=!0,A(!0)}catch(Re){console.error("Configurazione salvata non valida",Re)}if(!Q&&typeof __firebase_config<"u"&&(Q=JSON.parse(__firebase_config)),!Q){console.log("Modalità Offline attivata: Nessuna configurazione Firebase trovata."),m(!1),g(),l(!1);return}let we;try{o1().length>0?we=kd():we=yv(Q);const Re=SP(we);typeof __initial_auth_token<"u"&&__initial_auth_token&&!G?await cR(Re,__initial_auth_token):await sR(Re);const It=fR(Re,Pe=>{s(Pe),m(!0),l(!1)});return()=>It()}catch(Re){console.error("Errore inizializzazione Cloud, passaggio a locale:",Re),m(!1),g(),l(!1)}})()},[]);const g=()=>{try{const j=localStorage.getItem("migraine_logs_local");if(j){const K=JSON.parse(j);K.sort((Q,G)=>G.date!==Q.date?G.date.localeCompare(Q.date):G.time.localeCompare(Q.time)),r(K)}else r([])}catch(j){console.error("Errore lettura localStorage",j),r([])}};xe.useEffect(()=>{if(!f||!i)return;const j=_a(),Q=v?`users/${i.uid}/migraine_logs`:`artifacts/${typeof __app_id<"u"?__app_id:"default-app"}/users/${i.uid}/migraine_logs`,G=gC(oc(j,Q)),we=IC(G,Re=>{const It=Re.docs.map(Pe=>({id:Pe.id,...Pe.data()}));It.sort((Pe,Le)=>Le.date!==Pe.date?Le.date.localeCompare(Pe.date):Le.time.localeCompare(Pe.time)),r(It)},Re=>{console.error("Errore sync dati cloud:",Re)});return()=>we()},[i,f,v]);const _=xe.useMemo(()=>n.filter(j=>!(x.start&&j.date<x.start||x.end&&j.date>x.end)),[n,x]),I=()=>{try{JSON.parse(O),localStorage.setItem("migraine_firebase_config",O),alert("Configurazione salvata! L'app si ricaricherà per tentare la connessione Cloud."),window.location.reload()}catch{alert("JSON non valido. Controlla la sintassi.")}},C=()=>{confirm("Rimuovendo la configurazione tornerai alla modalità Locale (Standalone). I dati Cloud non saranno persi ma non saranno visibili qui.")&&(localStorage.removeItem("migraine_firebase_config"),window.location.reload())},R=()=>{k(null),E({...U,medications:[]}),e("entry")},S=j=>{k(j.id);let K=j.medications||[];K.length===0&&j.medicationName&&(K=[{name:j.medicationName,dosage:j.medicationDosage||""}]),E({date:j.date||"",time:j.time||"",duration:j.duration||"",intensity:j.intensity||5,hasAura:j.hasAura||!1,auraTypes:j.auraTypes||[],customAura:j.customAura||"",notes:j.notes||"",tookMedication:j.tookMedication||!1,medications:K,intensityAfterMeds:j.intensityAfterMeds||0}),e("entry")},mt=async()=>{if(!M.date){alert("Inserisci almeno la data.");return}h(!0);const j={...M,auraTypes:M.hasAura?M.auraTypes:[],customAura:M.hasAura?M.customAura:"",medications:M.tookMedication?M.medications:[],intensityAfterMeds:M.tookMedication?M.intensityAfterMeds:0,medicationName:M.tookMedication&&M.medications.length>0?M.medications[0].name:"",medicationDosage:M.tookMedication&&M.medications.length>0?M.medications[0].dosage:"",updatedAt:new Date().toISOString()};y||(j.createdAt=new Date().toISOString());try{if(f&&i){const K=_a(),G=v?`users/${i.uid}/migraine_logs`:`artifacts/${typeof __app_id<"u"?__app_id:"default-app"}/users/${i.uid}/migraine_logs`;y?await EC(Ih(K,G,y),j):await Sg(oc(K,G),j)}else{let K;if(y)K=n.map(Q=>Q.id===y?{...Q,...j}:Q);else{const Q={...j,id:Date.now().toString()+Math.random().toString(36).substr(2,9)};K=[...n,Q]}K.sort((Q,G)=>G.date!==Q.date?G.date.localeCompare(Q.date):G.time.localeCompare(Q.time)),r(K),localStorage.setItem("migraine_logs_local",JSON.stringify(K)),await new Promise(Q=>setTimeout(Q,500))}k(null),E(U),e("dashboard")}catch(K){console.error("Errore salvataggio:",K),alert("Errore nel salvataggio: "+K.message)}finally{h(!1)}},ln=async j=>{if(confirm("Sei sicuro di voler eliminare questo diario?"))try{if(f&&i){const K=_a(),G=v?`users/${i.uid}/migraine_logs`:`artifacts/${typeof __app_id<"u"?__app_id:"default-app"}/users/${i.uid}/migraine_logs`;await TC(Ih(K,G,j))}else{const K=n.filter(Q=>Q.id!==j);r(K),localStorage.setItem("migraine_logs_local",JSON.stringify(K))}}catch(K){console.error("Errore eliminazione:",K)}},yr=()=>{V.current.click()},jt=async j=>{const K=j.target.files[0];if(!K)return;if(!confirm(`Stai per importare dati in modalità ${f?"CLOUD":"LOCALE"}. Continuare?`)){j.target.value=null;return}const Q=new FileReader;Q.onload=async G=>{try{const we=JSON.parse(G.target.result);if(!Array.isArray(we))throw new Error("File non valido");h(!0);let Re=0;if(f&&i){const It=_a(),Le=v?`users/${i.uid}/migraine_logs`:`artifacts/${typeof __app_id<"u"?__app_id:"default-app"}/users/${i.uid}/migraine_logs`;for(const un of we){const{id:Oo,...Yi}=un;await Sg(oc(It,Le),Yi),Re++}}else{const It=we.map(Le=>({...Le,id:Le.id||Date.now().toString()+Math.random().toString(36).substr(2,9)})),Pe=[...n,...It];Pe.sort((Le,un)=>un.date!==Le.date?un.date.localeCompare(Le.date):un.time.localeCompare(Le.time)),r(Pe),localStorage.setItem("migraine_logs_local",JSON.stringify(Pe)),Re=It.length,await new Promise(Le=>setTimeout(Le,500))}alert(`Importazione completata! Aggiunte ${Re} voci.`)}catch(we){console.error(we),alert("Errore importazione: "+we.message)}finally{h(!1),j.target.value=null}},Q.readAsText(K)},B=()=>{const j=JSON.stringify(n,null,2),K=new Blob([j],{type:"application/json"}),Q=URL.createObjectURL(K),G=document.createElement("a");G.href=Q,G.download=`migraine_backup_${f?"cloud":"local"}.json`,G.click()},Y=()=>{let j="data:text/csv;charset=utf-8,";j+=`Data,Ora,Durata (h),Intensità (1-10),Aura,Dettagli Aura,Farmaci (Dettagli),Intensità Post-Farmaco,Note
...
`});const K=encodeURI(j),Q=document.createElement("a");Q.setAttribute("href",K),Q.setAttribute("download","emicrania_export.csv"),document.body.appendChild(Q),Q.click(),document.body.removeChild(Q)},te=()=>window.print(),de=j=>{if(!j.hasAura)return"No";if(Array.isArray(j.auraTypes)){let K=[...j.auraTypes];return j.customAura&&K.push(j.customAura),K.length>0?K.join(", "):"Non specificata"}return j.auraType||"Non specificata"},ue=j=>j.includes("Visiva")?"bg-blue-900/50 text-blue-300 border-blue-500/30":j.includes("Sensitiva")?"bg-purple-900/50 text-purple-300 border-purple-500/30":j.includes("Linguaggio")?"bg-pink-900/50 text-pink-300 border-pink-500/30":"bg-slate-700 text-slate-300 border-slate-500/30";return o?T.jsx("div",{className:"min-h-screen bg-slate-950 flex items-center justify-center text-slate-500",children:T.jsx("div",{className:"animate-pulse",children:"Caricamento..."})}):T.jsx("div",{className:"min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-indigo-500/30",children:T.jsx("div",{className:"max-w-md mx-auto min-h-screen relative shadow-2xl bg-slate-900 border-x border-slate-800",children:T.jsxs("main",{className:"p-4 pt-6",children:[t==="dashboard"&&T.jsx(RP,{logs:n,filteredLogs:_,totalLogs:_.length,totalLogsAllTime:n.length,avgIntensity:_.length>0?(_.reduce((j,K)=>j+parseInt(K.intensity||0),0)/_.length).toFixed(1):0,logsWithAura:_.filter(j=>j.hasAura).length,auraPercentage:_.length>0?Math.round(_.filter(j=>j.hasAura).length/_.length*100):0,onSettings:()=>e("settings"),onReport:()=>e("report"),onNewEntry:R,dateFilter:x,setDateFilter:D,isCloudMode:f,onEdit:S,onDelete:ln,renderAuraString:de,getAuraBadgeColor:ue}),t==="entry"&&T.jsx(CP,{formData:M,setFormData:E,onCancel:()=>e("dashboard"),onSubmit:mt,isSaving:u,editingId:y}),t==="settings"&&T.jsx(PP,{onBack:()=>e("dashboard"),isCloudMode:f,customConfigJson:O,setCustomConfigJson:w,onSaveConfig:I,onClearConfig:C,isUsingCustomConfig:v,onExportJSON:B,onImportClick:yr,isSaving:u,fileInputRef:V,onFileImport:jt}),t==="report"&&T.jsx(xP,{logs:n,filteredLogs:_,dateFilter:x,onBack:()=>e("dashboard"),onExportCSV:Y,onPrint:te,renderAuraString:de})]})})})}uc.createRoot(document.getElementById("root")).render(T.jsx(aE.StrictMode,{children:T.jsx(NP,{})}));
